...
typedef  struct
{
   ...
   unsigned int      Value_BAK;
   unsigned int      Timer_ACT;               
...
void        Set_Mode_Flap(unsigned char  Sts);
void        Set_Mix_Flap(unsigned char  Sts);
void        Set_Rec_Flap(unsigned char  Sts);
void        Set_AC_Con(unsigned char   Sts);
void        Set_Reardef(unsigned char  Sts);
void        Set_Blower_Speed(unsigned char  Sts);
...
void Set_Lcd_Back(unsigned char    Sts);
void Set_Lcd_Fullon(unsigned char  Sts);
void Set_Lcd_Blower(unsigned char  Sts);
void Set_Lcd_Mode(unsigned char   Sts);
void Set_Lcd_Tem(unsigned int  Sts);
void Set_Lcd_Ac(unsigned char  Sts);
void Set_Lcd_Rec(unsigned char  Sts);
void Set_Lcd_Econ(unsigned char  Sts);
void Set_Lcd_Auto(unsigned char  Sts);
 

void   Set_Hardware_Mode(unsigned char  );
void   Set_Hardware_Tem(unsigned char  );
void   Set_Hardware_Rec(unsigned char  );
void   Set_Hardware_Blw_Relay(unsigned char );
void   Set_Hardware_PWM(unsigned int );
void   Set_Hardware_AC(unsigned char );
void   Set_Hardware_Reardef(unsigned char );



void   Set_Hardware_Lcd_Back(unsigned char  n);
void   Set_Hardware_Lcd_Fullon(unsigned char  n);
void   Set_Hardware_Lcd_Blower(unsigned char  n);
void   Set_Hardware_Lcd_Mode(unsigned char  n);
void   Set_Hardware_Lcd_Tem(unsigned int  n);
void   Set_Hardware_Lcd_Ac(unsigned char  n);
void   Set_Hardware_Lcd_Rec(unsigned char  n);
void   Set_Hardware_Lcd_Econ(unsigned char  n);
void   Set_Hardware_Lcd_Auto(unsigned char  n);
...
void   Data1_Display( unsigned char  Data);
void   Data2_Display( unsigned char  Data);
void   Data3_Display( unsigned char  Data);
...
void  Init_LCD(void);
void  Write_Byte_Comand( unsigned char  Command, unsigned char  Data_Setting);
void  Write_Signal_Data(unsigned char  Add, unsigned char  Data);
void  Write_Page_Data(unsigned char  Add1, unsigned char  Add2, unsigned char  Add3);
void  IIC_Start(void);
void  IIC_ChaAck(void);
void  IIC_Send8bit(unsigned char  Data);
void  IIC_Stop(void);
...
unsigned int  Get_AD_Word(unsigned char );

void  Input_Sensor_Proc(void);
void  Init_MCU_AD(void);

void Inside_Tem_Init(void);
void Inside_Tem_Detect(void);
unsigned char   Inside_Tem_AdtoTem( unsigned int  );


void Outside_Tem_Init(void);
void Outside_Tem_Detect(void);
unsigned char   Outside_Tem_AdtoTem( unsigned int  );

void Sun_Sensor_Init(void);
void Sun_Sensor_Detect(void);
unsigned char  Sun_Sensor_AdtoSun( unsigned int  );


void Evap_Sensor_Init(void);
void Evap_Sensor_Detect(void);
unsigned char   Evap_Sensor_AdtoTem( unsigned int  );


void Module_Feedback_Init(void);
void Module_Feedback_Detect(void);
unsigned char   Module_Feedback_AdtoVoltage(unsigned int );

void IGN_Feedback_Init(void);
void IGN_Feedback_Detect(void);
unsigned int   IGN_Feedback_AdtoVoltage(unsigned int );

void BATT_Feedback_Init(void);
void BATT_Feedback_Detect(void);
unsigned int   BATT_Feedback_AdtoVoltage(unsigned int );

void Motor_Tem_Init(void);
void Motor_TemFeedback_Detect(void);
unsigned int   Motor_TemFeedback_AdtoVoltage(unsigned int );


void Motor_Mode_Init(void);
void Motor_ModeFeedback_Detect(void);
unsigned int   Motor_MotorFeedback_AdtoVoltage(unsigned int );
...
unsigned int      Feedback_GetValue( unsigned char  Channel);

unsigned char       Sensor_GetValue(unsigned char  Channel);

unsigned char       Feedback_GetSatus(unsigned char  Channel);
unsigned char       Sensor_GetSatus(unsigned char  Channel);
...
{  
   ...
   unsigned int    FaultDetectTimerOutCount;
   
   unsigned int    Value_ECU;      
   unsigned int    Value_UDS;      
...
typedef struct
{
 ...
 unsigned char     Interval;
 unsigned int    TimerOutCountOverVoltage;
 unsigned int    TimerOutCountUnderVoltage;
 unsigned int    TimerOutCountReturnVoltage;
...
typedef  struct
{
 ...
 unsigned int     InitTimeoutCnt;

 unsigned int     BusOff;
 unsigned int    BusOffCount;
 
 unsigned char     EMS4Status;
 unsigned char     EMS2Status;
 unsigned char     ABSStatus;
 unsigned char     BCMStatus;
  
   
 unsigned int    EMS4TimeoutCnt;
 unsigned int    EMS2TimeoutCnt;
 unsigned int    ABSTimeoutCnt;     
 unsigned int    BCMTimeoutCnt;

 unsigned int    ACSendTimeroutcnt1;  
 unsigned int    ACSendTimeroutcnt2;     
...
unsigned int      CAN_Get_RxMsg(void);
void        CAN_Put_RxMsg(void);
void        CAN_BuildFrame_Calibration1(void);
void        CAN_BuildFrame_Calibration2(void);

unsigned int      CAN_SendFrame(CAN_TXMSG msg);

void        CAN_pro(void);

unsigned int      CAN_GetValue(unsigned char Channel);
unsigned char       CAN_GetSatus(unsigned char  Channel);
...
void       PutMsg_Diag_PowerStatus( unsigned char Sts );
void       PutMsg_Diag_InTemSensorStatus( unsigned char Sts );
void       PutMsg_Diag_OutTemSensorStatus( unsigned char Sts );
void       PutMsg_Diag_SunSensorStatus( unsigned char Sts );
void       PutMsg_Diag_EvapSensorStatus( unsigned char Sts );   
void       PutMsg_Diag_ModeFbStatus( unsigned char Sts );
void       PutMsg_Diag_ModeMoveStatus( unsigned char Sts );
void       PutMsg_Diag_MixFbStatus( unsigned char Sts );
void       PutMsg_Diag_MixMoveStatus( unsigned char Sts );
void       PutMsg_Diag_RecMoveStatus( unsigned char Sts );
void       PutMsg_Diag_BLWStatus( unsigned char Sts );
void       PutMsg_Diag_EMS4ComStatus( unsigned char Sts );
void       PutMsg_Diag_EMS2ComStatus( unsigned char Sts );
void       PutMsg_Diag_ABSComStatus( unsigned char Sts );


void      PutMsg_Calibr_IncarTem(unsigned char Sts) ;
void      PutMsg_Calibr_OutcarTem(unsigned char Sts);
void      PutMsg_Calibr_SetcarTem(unsigned char Sts) ;
void      PutMsg_Calibr_EvapTem(unsigned char Sts) ;
void      PutMsg_Calibr_SunSensor(unsigned char Sts);
void      PutMsg_Calibr_EngineeCoolWater(unsigned char Sts);
void      PutMsg_Calibr_EngineeSpeed(unsigned int Sts);
void      PutMsg_Calibr_VechleSpeed(unsigned int Sts);

void      PutMsg_Calibr_MixPosition(unsigned char  Sts);
void      PutMsg_Calibr_ModePosition(unsigned char  Sts);
void      PutMsg_Calibr_RecPosition(unsigned char Sts);
void      PutMsg_Calibr_BlowerFeedback(unsigned char Sts);
void      PutMsg_Calibr_OperationMode(unsigned char Sts);
void      PutMsg_Calibr_TdValue(unsigned int  Sts);

void      PutMsg_Calibr_AcOutputStatus(unsigned char Sts);
#line 5 "io.c"
#line 6 "io.c"
...
unsigned int           FLG_7708A;
unsigned int           FLG_E910;
unsigned int           BAK_FLG_7708A;


unsigned char            IIC_ACK_Flag;
unsigned int           Timer_IIC_Waitting;
...
unsigned char             Set_Posi_Tem;
unsigned char             Set_Posi_Mode;
unsigned char             Set_Posi_Rec;
unsigned char             Set_Blw_Level;
unsigned char             Set_AC;
unsigned char             Set_Reardefo;

unsigned char             Set_Lcd_Backlight;
unsigned char             Set_Lcd_FullOn;

unsigned char             Set_Lcd_Blw;
unsigned char             Set_Lcd_Modedrive;
unsigned int            Set_Lcd_Temp;
unsigned char             Set_Lcd_Acdrive;
unsigned char             Set_Lcd_Recdrive;
unsigned char             Set_Lcd_Econdrive;
unsigned char             Set_Lcd_Autodrive;




unsigned char            ACT_TEM_DIR;
unsigned char            ACT_MODE_DIR;
unsigned char            ACT_REC_DIR;
unsigned char            ACT_BLW_RELAY_OUT;
unsigned char            ACT_AC_OUT;
unsigned char            ACT_REARDEF_OUT;
unsigned char            ACT_LCD_BACKLITHT_OUT;


unsigned int          Blw_PWM;
unsigned int          Timer_Blw_PWM_Step;

unsigned char   	  	   LCD_BUFF[6 ];



void          Set_Mode_Flap(unsigned char  Sts)     {Set_Posi_Mode=Sts;}
void          Set_Mix_Flap(unsigned char  Sts)      {Set_Posi_Tem=Sts; }
void          Set_Rec_Flap(unsigned char  Sts)      {Set_Posi_Rec=Sts;}
void          Set_AC_Con(unsigned char  Sts)        {Set_AC=Sts;}
void          Set_Reardef(unsigned char  Sts)       {Set_Reardefo=Sts;}
void          Set_Blower_Speed(unsigned char  Sts)  {Set_Blw_Level=Sts;}



void          Set_Lcd_Back(unsigned char  Sts)      {Set_Lcd_Backlight =Sts;}
void          Set_Lcd_Fullon(unsigned char  Sts)    {Set_Lcd_FullOn=Sts; }
void          Set_Lcd_Blower(unsigned char  Sts)    {Set_Lcd_Blw=Sts; }

void          Set_Lcd_Mode(unsigned char  Sts)      {Set_Lcd_Modedrive=Sts;}
void          Set_Lcd_Tem(unsigned int  Sts)      {Set_Lcd_Temp=Sts; }
void          Set_Lcd_Ac(unsigned char  Sts)        {Set_Lcd_Acdrive=Sts; }
void          Set_Lcd_Rec(unsigned char  Sts)       {Set_Lcd_Recdrive=Sts; }
void          Set_Lcd_Econ(unsigned char  Sts)      {Set_Lcd_Econdrive=Sts; }
void          Set_Lcd_Auto(unsigned char  Sts)      {Set_Lcd_Autodrive=Sts; }




 
void   Set_Hardware_Mode(unsigned char  Sts)
{
ACT_MODE_DIR=Sts;
}

void   Set_Hardware_Tem(unsigned char  Sts)
{
ACT_TEM_DIR=Sts;
}

void   Set_Hardware_Rec(unsigned char  Sts)
{
ACT_REC_DIR=Sts;
}

void Set_Hardware_Blw_Relay(unsigned char  Sts)
{
ACT_BLW_RELAY_OUT=Sts;
}

void   Set_Hardware_PWM(unsigned int  Sts)
{ 
  CCPR3L    = Sts/4; 
  CCP3CON  =  0xFC;                    
  CCP3CON &= ((((Sts%4)<<4)&0X30)|0xCF);   
}
void Set_Hardware_AC(unsigned char  Sts)
{
...
void Set_Hardware_Reardef(unsigned char  Sts)
{
ACT_REARDEF_OUT=Sts;
}
...
void  Motor_Tem_Action_Pro()
{
 ...
 Motor_Control_Tem.Value_IN=Feedback_GetValue(2 );

if(Feedback_GetSatus(2 )!=0X01 )
{
 Motor_Control_Tem.Dir=1 ;
}
else
{
 ...
 if(Motor_Control_Tem.Value_SET !=Motor_Control_Tem.Value_BAK)
 {
  ...
  if(Motor_Control_Tem.Value_IN > Motor_Control_Tem.Value_SET+2 )
  {
   Motor_Control_Tem.Dir=3 ;
   Motor_Control_Tem.Timer_ACT =8000 ;
  }
  else if(Motor_Control_Tem.Value_IN<Motor_Control_Tem.Value_SET-2 )
  {
   Motor_Control_Tem.Dir=4 ;
   Motor_Control_Tem.Timer_ACT =8000 ;
  }
 }

if(Motor_Control_Tem.Dir==3 )
{
if((Motor_Control_Tem.Value_IN<=(Motor_Control_Tem.Value_SET+2 ))&&(Motor_Control_Tem.Value_IN>=(Motor_Control_Tem.Value_SET-2 )))
{ Motor_Control_Tem.Dir=2 ;     Motor_Control_Tem.Timer_ACT =100 ; 
...
else if(Motor_Control_Tem.Timer_ACT==0) 
{
 ...
 if(Feedback_GetSatus(2 )==0X01 &&Feedback_GetSatus( 4  )==C_POWER_NORMAL)                           
 {PutMsg_Diag_MixMoveStatus(1); }              
 }   
else{;}
}

if(Motor_Control_Tem.Dir==4 )
{
if((Motor_Control_Tem.Value_IN>=(Motor_Control_Tem.Value_SET-2 ))&&(Motor_Control_Tem.Value_IN<=(Motor_Control_Tem.Value_SET+2 )))
{ Motor_Control_Tem.Dir=2 ;     Motor_Control_Tem.Timer_ACT =100 ;
  PutMsg_Diag_MixMoveStatus(0);
...
Motor_Control_Mode.Value_IN=Feedback_GetValue(1 );

if(Feedback_GetSatus(1 )!=0X01 )
{
Motor_Control_Mode.Dir=1 ;
}
else
{
 ...
 if( Motor_Control_Mode.Value_SET != Motor_Control_Mode.Value_BAK)
 {
  ...
  if( Motor_Control_Mode.Value_IN >  Motor_Control_Mode.Value_SET+2 )
  {
    Motor_Control_Mode.Dir=4 ;
    Motor_Control_Mode.Timer_ACT =8000 ;
  }
  else if( Motor_Control_Mode.Value_IN< Motor_Control_Mode.Value_SET-2 )
  {
    Motor_Control_Mode.Dir=3 ;
    Motor_Control_Mode.Timer_ACT =8000 ;
  }
 }

if( Motor_Control_Mode.Dir==4 )
{
if(( Motor_Control_Mode.Value_IN<=( Motor_Control_Mode.Value_SET+2 ))&&( Motor_Control_Mode.Value_IN>=( Motor_Control_Mode.Value_SET-2 )))
{  
 Motor_Control_Mode.Dir=2 ;      Motor_Control_Mode.Timer_ACT =100 ;
...
else if( Motor_Control_Mode.Timer_ACT==0) 
{
 ...
 if(Feedback_GetSatus(1 )==0X01 &&Feedback_GetSatus( 4  )==C_POWER_NORMAL) 
{
...
{
  Motor_Control_Rec.Dir= 1 ;
  Motor_Control_Rec.Value_BAK=Motor_Control_Rec.Value_SET;
  Motor_Control_Rec.Timer_ACT=8000 ;
  if(Motor_Control_Rec.Value_SET==0 )
  {
  Motor_Control_Rec.Dir= 4 ;
  
  }
  else if (Motor_Control_Rec.Value_SET==1 )
  {
   Motor_Control_Rec.Dir= 3 ;
   
  }
}

if(Motor_Control_Rec.Dir==4 )
{ 

if(Motor_Control_Rec.Timer_ACT==0)    { Motor_Control_Rec.Dir= 2 ; Motor_Control_Rec.Timer_ACT=100 ;}                         
}
if(Motor_Control_Rec.Dir==3 )
{

if(Motor_Control_Rec.Timer_ACT==0)    { Motor_Control_Rec.Dir= 2 ; Motor_Control_Rec.Timer_ACT=100 ;}                         
}
if(Motor_Control_Rec.Dir==100 )
{
if(Motor_Control_Rec.Timer_ACT==0)    { Motor_Control_Rec.Dir= 1 ; }
}
...
if(Timer_Blw_PWM_Step==0)
{
 ...
 if(Menu_AUTO)
 {Timer_Blw_PWM_Step = 50 ;}
 else
 {Timer_Blw_PWM_Step = 20 ;}
...
if(Set_Blw_Level==0)
{ 
 Set_Hardware_Blw_Relay(0 );
}
else
{
 Set_Hardware_Blw_Relay(1 );
}
...
{  
    if(Set_Reardefo==1 )
    Set_Hardware_Reardef(1 );
    else
    Set_Hardware_Reardef(0 );
 }
...
if(ACT_BLW_RELAY_OUT==1 )  {OUT_MODULE_ENABLE =1; OUT_MODULE_PROTECT=0;}   else {OUT_MODULE_ENABLE=0; OUT_MODULE_PROTECT=1; } 
if(ACT_AC_OUT==1 )         {OUT_AC =1;
 PutMsg_Calibr_AcOutputStatus(1);}              
else {OUT_AC=0; PutMsg_Calibr_AcOutputStatus(0); }
if(ACT_REARDEF_OUT==1 )    {OUT_REDEF =1;}             else {OUT_REDEF =0;          } 
if(ACT_LCD_BACKLITHT_OUT==1 ) { OUT_LCD_BACKLIGHT =1;} else{OUT_LCD_BACKLIGHT=0;  }
...
TO_7708_CLK=0;
TO_7708_SI=0;
{_asm nop _endasm}  ;{_asm nop _endasm}  ;{_asm nop _endasm}  ;{_asm nop _endasm}  ;
TO_7708_CSB=0;
{_asm nop _endasm}  ;{_asm nop _endasm}  ;{_asm nop _endasm}  ;
for(i=0;i<16;i++)
{
 
 TO_7708_CLK=1; {_asm nop _endasm}  ;{_asm nop _endasm}  ;{_asm nop _endasm}  ;
 if(FLG_7708A&0X0001) TO_7708_SI=1; else TO_7708_SI=0;
 TO_7708_CLK=0; {_asm nop _endasm}  ;{_asm nop _endasm}  ;{_asm nop _endasm}  ;
 FLG_7708A>>=1;
...
{ 
unsigned char  i;
if(n==0 )      {for(i=0;i<6 ;i++)  LCD_BUFF[i] =0x00; }
else if(n==1 )  {for(i=0;i<6 ;i++)  LCD_BUFF[i] =0xFF; } 
}

void   Set_Hardware_Lcd_Blower(unsigned char  n)
{ 
if(n>=0)       { LCD_BUFF[LCD_ID_BLW_LABLE/8]|=(0X01)<<(LCD_ID_BLW_LABLE%8) ;}
if(n>=1)       { LCD_BUFF[LCD_ID_BLW1/8]|=(0X01)<<(LCD_ID_BLW1%8) ;}
if(n>=2)       { LCD_BUFF[LCD_ID_BLW2/8]|=(0X01)<<(LCD_ID_BLW2%8) ;}
if(n>=3)       { LCD_BUFF[LCD_ID_BLW3/8]|=(0X01)<<(LCD_ID_BLW3%8) ;}
if(n>=4)       { LCD_BUFF[LCD_ID_BLW4/8]|=(0X01)<<(LCD_ID_BLW4%8) ;}
if(n>=5)       { LCD_BUFF[LCD_ID_BLW5/8]|=(0X01)<<(LCD_ID_BLW5%8) ;}
if(n>=6)       { LCD_BUFF[LCD_ID_BLW6/8]|=(0X01)<<(LCD_ID_BLW6%8) ;}
if(n>=7)       { LCD_BUFF[LCD_ID_BLW7/8]|=(0X01)<<(LCD_ID_BLW7%8) ;}
}
void   Set_Hardware_Lcd_Mode(unsigned char  n)
{ 
 LCD_BUFF[LCD_ID_BODY/8]|=(0X01)<<(LCD_ID_BODY%8) ;
 if(n==0 ||n==1 ) {LCD_BUFF[LCD_ID_FACE/8]|=(0X01)<<(LCD_ID_FACE%8) ;}
 if(n==2 ||n==3 ||n==1 )  {LCD_BUFF[LCD_ID_FOOT/8]|=(0X01)<<(LCD_ID_FOOT%8) ;}
 if(n==4 ||n==3 )   {LCD_BUFF[LCD_ID_DEF/8]|=(0X01)<<(LCD_ID_DEF%8) ;}
}

void  Data1_Display( unsigned char  Data)
{
if     (Data==0)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;   LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ;  LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ; LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ; LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;}
else if(Data==1)  {LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;   LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ; }
else if(Data==2)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;  LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;  LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ;    LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;}
else if(Data==3)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;  LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ;   LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;}
else if(Data==4)  {LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;   LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ; LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;}
else if(Data==5)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;  LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ;   LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;}
else if(Data==6)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;  LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ;   LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ; LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ; }
else if(Data==7)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ; }
else if(Data==8)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ; LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;   LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ; LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ; LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;}
else if(Data==9)  {LCD_BUFF[LCD_ID_1A/8]|=(0X01)<<(LCD_ID_1A%8) ;   LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;  LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ; LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;   LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;  LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;}
else {;}
}

void  Data2_Display( unsigned char  Data)
{
if(Data==0)       {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;   LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;  LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ; LCD_BUFF[LCD_ID_2E/8]|=(0X01)<<(LCD_ID_2E%8) ; LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;}
else if(Data==1)  {LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;   LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ; }
else if(Data==2)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;  LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;  LCD_BUFF[LCD_ID_2E/8]|=(0X01)<<(LCD_ID_2E%8) ;    LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;}
else if(Data==3)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;  LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;   LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;}
else if(Data==4)  {LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;   LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;   LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;}
else if(Data==5)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;  LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;   LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;}
else if(Data==6)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;  LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;   LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ; LCD_BUFF[LCD_ID_2E/8]|=(0X01)<<(LCD_ID_2E%8) ; }
else if(Data==7)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ; }
else if(Data==8)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ; LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;   LCD_BUFF[LCD_ID_2E/8]|=(0X01)<<(LCD_ID_2E%8) ; LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ; LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;}
else if(Data==9)  {LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;   LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;  LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ; LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;   LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;  LCD_BUFF[LCD_ID_2G/8]|=(0X01)<<(LCD_ID_2G%8) ;}
else {;}
}
...
void  Data3_Display( unsigned char  Data)
{
if     (Data==0)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;   LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ;  LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ; LCD_BUFF[LCD_ID_3E/8]|=(0X01)<<(LCD_ID_3E%8) ; LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ;}
else if(Data==1)  {LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;   LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ; }
else if(Data==2)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;  LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;  LCD_BUFF[LCD_ID_3E/8]|=(0X01)<<(LCD_ID_3E%8) ;    LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ;}
else if(Data==3)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;  LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ;   LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ;}
else if(Data==4)  {LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;   LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;   LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ;   LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ;}
else if(Data==5)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ;  LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ;   LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ;}
else if(Data==6)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ;  LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ;   LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ; LCD_BUFF[LCD_ID_3E/8]|=(0X01)<<(LCD_ID_3E%8) ; }
else if(Data==7)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ; }
else if(Data==8)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ; LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ;   LCD_BUFF[LCD_ID_3E/8]|=(0X01)<<(LCD_ID_3E%8) ; LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ; LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;}
else if(Data==9)  {LCD_BUFF[LCD_ID_3A/8]|=(0X01)<<(LCD_ID_3A%8) ;   LCD_BUFF[LCD_ID_3B/8]|=(0X01)<<(LCD_ID_3B%8) ;  LCD_BUFF[LCD_ID_3C/8]|=(0X01)<<(LCD_ID_3C%8) ; LCD_BUFF[LCD_ID_3D/8]|=(0X01)<<(LCD_ID_3D%8) ;   LCD_BUFF[LCD_ID_3F/8]|=(0X01)<<(LCD_ID_3F%8) ;  LCD_BUFF[LCD_ID_3G/8]|=(0X01)<<(LCD_ID_3G%8) ;}
else {;}
}
...
unsigned int  Data_Second;
unsigned int  Data_Third;
...
LCD_BUFF[LCD_ID_TEM_UNIT/8]|=(0X01)<<(LCD_ID_TEM_UNIT%8) ;
...
{
LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ;LCD_BUFF[LCD_ID_1G/8]|=(0X01)<<(LCD_ID_1G%8) ;LCD_BUFF[LCD_ID_1B/8]|=(0X01)<<(LCD_ID_1B%8) ;LCD_BUFF[LCD_ID_1C/8]|=(0X01)<<(LCD_ID_1C%8) ;
LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;

}
else if(n==180 )
{
LCD_BUFF[LCD_ID_1F/8]|=(0X01)<<(LCD_ID_1F%8) ;LCD_BUFF[LCD_ID_1E/8]|=(0X01)<<(LCD_ID_1E%8) ;LCD_BUFF[LCD_ID_1D/8]|=(0X01)<<(LCD_ID_1D%8) ;
LCD_BUFF[LCD_ID_2A/8]|=(0X01)<<(LCD_ID_2A%8) ;LCD_BUFF[LCD_ID_2F/8]|=(0X01)<<(LCD_ID_2F%8) ;LCD_BUFF[LCD_ID_2E/8]|=(0X01)<<(LCD_ID_2E%8) ;LCD_BUFF[LCD_ID_2D/8]|=(0X01)<<(LCD_ID_2D%8) ;LCD_BUFF[LCD_ID_2B/8]|=(0X01)<<(LCD_ID_2B%8) ;LCD_BUFF[LCD_ID_2C/8]|=(0X01)<<(LCD_ID_2C%8) ;
...
{ 
if(n==1 )
{LCD_BUFF[LCD_ID_AC/8]|=(0X01)<<(LCD_ID_AC%8) ; }
}
void   Set_Hardware_Lcd_Rec(unsigned char  n)
{ 
if(n==0 )       {LCD_BUFF[LCD_ID_INSIDE/8]|=(0X01)<<(LCD_ID_INSIDE%8) ; }
else if(n==1 ) {LCD_BUFF[LCD_ID_OUTSIDE/8]|=(0X01)<<(LCD_ID_OUTSIDE%8) ;}
}

void   Set_Hardware_Lcd_Econ(unsigned char  n)
{  
if(n==1 ) {LCD_BUFF[LCD_ID_ECON/8]|=(0X01)<<(LCD_ID_ECON%8) ;}           
}

void   Set_Hardware_Lcd_Auto(unsigned char  n)
{
 if(n==1 ) {LCD_BUFF[LCD_ID_AUTO/8]|=(0X01)<<(LCD_ID_AUTO%8) ;} 
}
