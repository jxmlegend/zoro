...
{ 					
  ...
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_FSMC,ENABLE);	//使能FSMC时钟
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOG,ENABLE);//使能PORTB,D,E,G以及AFIO复用功能时钟
 	...
 	//PORTD复用推挽输出  
	//D0-FSMC_D2  D1-FSMC_D3 	D4-FSMC_NOE-LCD_RD  D5-FSMC_NWE-LCD_WR  D8-FSMC_D13  D9-FSMC_D14	D10-FSMC_D15  D14-FSMC_D0  D15-FSMC_D1
	...
	//PORTE复用推挽输出 
	//E7-FSMC_D4 E8-FSMC_D5 E9-FSMC_D6  E10-FSMC_D7  E11-FSMC_D8  E12-FSMC_D9  E13-FSMC_D10  E14-FSMC_D11  E15-FSMC_D12  
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15;				 //	//PORTD复用推挽输出  
 	...
 	GPIO_Init(GPIOE, &GPIO_InitStructure);    	    	 											 
   		...
   		//	//PORTG12复用推挽输出 A0
	//G0-FSMC_A10-LCD_RS  G12-FSMC_NE4-LCD_CS	
